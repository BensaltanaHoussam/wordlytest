...
<!-- FIRST SECTION -->
    ...
    <div class="flex rounded-3xl w-[85%]  justify-around gap-24 items-center py-3 px-4 md:px-24 bg-white"> 
      ...
      <div class="text-center mt-12">
        ...
        <div class="mt-8">
          <a href="#" class="text-white text-lg border-2 rounded-3xl py-1 px-8 hover:text-green-950 hover:bg-white hover:border-white transform duration-300 drop-shadow-2xl ">Travel the world!<i class="ri-skip-down-line ml-4"></i></a>
        </div>
...
<!-- AFRICA INFO -->
    ...
    <section class=" landingPages">
      ...
      <div class=" py-8  ">
        ...
        <div>
          <a href="countries-form.php" class="text-white text-sm border-2  px-2 py-1 hover:text-green-950 hover:bg-white hover:border-white transform duration-300 drop-shadow-2xl ">Add Continents <i class="ri-add-line"></i></a>
        </div>
      ...
      <div class="">
        ...
        <div class="relative w-[400px] hover:bg-black/30">
            ...
            <div class="absolute bottom-0 w-full h-[100px] text-white text-xl font-bold bg-black/30 rounded-b-lg px-4">
              ...
              <h1>ANTARCTICA</h1>
              <div>
              <a href="#"><i class="ri-edit-fill text-sm text-slate-200 hover:text-green-900 transform duration-300"></i></a>
              <a href="#"><i class="ri-delete-bin-7-fill text-sm text-slate-200 hover:text-green-900 transform duration-300"></i></a>
              </div>
