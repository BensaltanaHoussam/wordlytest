...
<section class="bg-[url('./img/ANTAR.jpg')] pt-6 flex flex-col items-center h-[350px]">

<div class="flex rounded-3xl w-[85%]  justify-around gap-24 items-center py-3 px-4 md:px-24 bg-white"> 
  
  <a href="/TEST2"><img  class="w-[160px]" src="./img/Black White Stylish Minimalist Small World Logo.png" alt="logo"></a>
  ...
  <div class="flex gap-12 items-center" >
    ...
    <div class="text-black bg-white/70 rounded-3xl flex flex-col md:flex-row items-center px-4 py-8 md:px-20 gap-4 md:gap-20 mt-16">
  ...
  <div class=" py-8  ">
        ...
        <P class="text-white font-light ml-16 pt-1 ">This is the best 3 Countrys on africa :</P>
          ...
          <img  class="w-[300px] flex rounded-xl" src="./img/EUROPE.jpg" alt="country"">
    <div>
...
<div>
      ...
      <P class="text-lg pb-4 md:w-[600px]">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ratione iste provident ipsum nemo magni, ea dolor, libero omnis molestiae tempora odio eum. Sunt mollitia nostrum deserunt consequuntur facere eligendi neque.</P>
      <P class="bg-black text-center text-white cursor-pointer p-1 px-4 hover:bg-white hover:text-black border-2 transform duration-300">Explore cities</P>
